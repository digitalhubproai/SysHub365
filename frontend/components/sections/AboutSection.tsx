...
export function AboutSection() {
  return (
    <section id="about" className="section-padding bg-[var(--obsidian-surface)] border-y border-white/5 relative z-10 overflow-hidden">
      <div className="absolute top-1/2 left-0 w-[500px] h-[500px] rounded-full -translate-y-1/2 pointer-events-none" aria-hidden="true" style={{ background: 'radial-gradient(circle, rgba(37,99,235,0.05) 0%, transparent 70%)' }} />
      ...
      <div className="max-w-[90rem] mx-auto grid lg:grid-cols-2 gap-10 lg:gap-24 items-center relative z-10">
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute top-8 right-8 bg-black/60 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex flex-col items-center min-w-[120px] shadow-2xl"
          >
        ...
        <div className="flex flex-col gap-8">
          <div>
            <span className="inline-flex items-center gap-2 text-electric-blue font-black tracking-[0.3em] uppercase text-sm">
              <span className="w-8 h-px bg-electric-blue" /> About Us
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mt-4">
          ...
          <div className="flex flex-col gap-5 text-slate-400 text-base leading-relaxed">
            <p>SysHub365 isn&apos;t just an outsourced vendor. We integrate deeply with your business to understand your goals, target audience, and market challenges before writing a single line of code.</p>
            <p>We consist of elite software engineers, UI/UX designers, and AI specialists who have delivered solutions across Fintech, Healthcare, E-Commerce, and SaaS. We believe in sheer transparency, rapid agile delivery, and uncompromising quality.</p>
          </div>
